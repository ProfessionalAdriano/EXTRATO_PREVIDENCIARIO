...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------                                           
    ...
    BEGIN
        G_ARQ := UTL_FILE.FOPEN(G_DIR,G_NAME,G_READ,G_SIZE);
          ...
          dbms_output.put_line('L_COUNT_II: '|| to_char(L_COUNT_II));
                ...
                BEGIN
                  ...
                  LOOP
                    ...
                    ELSIF RG_REC_CARGA.INDX = 2 THEN 
                      REC_CARGA.COD_EMPRS := RG_REC_CARGA.DADO;
                     
                    ELSIF RG_REC_CARGA.INDX = 3 THEN 
                      REC_CARGA.NUM_RGTRO_EMPRG := RG_REC_CARGA.DADO;
                      
                    ELSIF RG_REC_CARGA.INDX = 4 THEN 
                      REC_CARGA.NOM_EMPRG := RG_REC_CARGA.DADO;
                ...
                -- INSERT INTO OWN_FUNCESP.FC_PRE_TBL_CARGA_EXTRATO SET ROW TB_REC_CARGA;
