...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    IS
      ...
      -- SUST-8330 - Efetuado implementacao no cursor C_TRATA_DADOS para tratar as quebras de linha:
      CURSOR C_TRATA_DADOS IS
               SELECT DECODE(TO_NUMBER(REPLACE(TPO_DADO,CHR(13), '')),1,2)                                                                                    AS TPO_DADO
                     ,TO_NUMBER(REPLACE(COD_EMPRS,CHR(13), ''))                                                                                               AS COD_EMPRS
                     ,REPLACE(NUM_RGTRO_EMPRG, CHR(13), '')                                                                                                   AS NUM_RGTRO_EMPRG
                     ,REPLACE(NOM_EMPRG, CHR(13), '')                                                                                                         AS NOM_EMPRG
                  ,CASE
                   ...
                   END                                                                                                                              AS DTA_EMISS
                  ,REPLACE(NUM_FOLHA, CHR(13), '')                                                                                                  AS NUM_FOLHA
                  ,REPLACE(DCR_PLANO, CHR(13), '')                                                                                                  AS DCR_PLANO
                  ,REPLACE(PER_INIC_EXTR, CHR(13), '')                                                                                              AS PER_INIC_EXTR
                  ,REPLACE(PER_FIM_EXTR, CHR(13), '')                                                                                               AS PER_FIM_EXTR
                  ,CASE
                  ...
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_PL_SALDADO_MOV_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))        AS SLD_PL_SALDADO_MOV_INIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_PL_SALDADO_MOV,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))             AS CTB_PL_SALDADO_MOV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_PL_SALDADO_MOV,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))            AS RENT_PL_SALDADO_MOV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_PL_SALDADO_MOV_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS SLD_PL_SALDADO_MOV_FIM
                  ,TRIM(REPLACE(DCR_SLD_MOV_BD,CHR(13),''))                                                                                         AS DCR_SLD_MOV_BD                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_PL_BD_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                 AS SLD_PL_BD_INIC                 
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_PL_MOV_BD,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                  AS CTB_PL_MOV_BD                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_PL_MOV_BD,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                 AS RENT_PL_MOV_BD                                                      
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_PL_BD_MOV_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS SLD_PL_BD_MOV_FIM
                  ,TRIM(REPLACE(DCR_SLD_MOV_CV,CHR(13),''))                                                                                         AS DCR_SLD_MOV_CV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_PL_CV_MOV_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))             AS SLD_PL_CV_MOV_INIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_PL_MOV_CV,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                  AS CTB_PL_MOV_CV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_PL_MOV_CV,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                 AS RENT_PL_MOV_CV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_PL_CV_MOV_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS SLD_PL_CV_MOV_FIM
                  ,TRIM(REPLACE(DCR_CTA_OBRIG_PARTIC, CHR(13),''))                                                                                  AS DCR_CTA_OBRIG_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_CTA_OBRIG_PARTIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS SLD_CTA_OBRIG_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_CTA_OBRIG_PARTIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS CTB_CTA_OBRIG_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_CTA_OBRIG_PARTIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS RENT_CTA_OBRIG_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_CTA_OBRIG_PARTIC_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))       AS SLD_CTA_OBRIG_PARTIC_FIM
                  ,TRIM(REPLACE(DCR_CTA_NORM_PATROC,CHR(13),''))                                                                                    AS DCR_CTA_NORM_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_CTA_NORM_PATROC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))            AS SLD_CTA_NORM_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_CTA_NORM_PATROC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))            AS CTB_CTA_NORM_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_NORM_PATROC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))               AS RENT_NORM_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_NORM_PATROC_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS SLD_NORM_PATROC_INIC
                  ,TRIM(REPLACE(DCR_CTA_ESPEC_PARTIC,CHR(13),''))                                                                                   AS DCR_CTA_ESPEC_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_CTA_ESPEC_PARTIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS SLD_CTA_ESPEC_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_CTA_ESPEC_PARTIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS CTB_CTA_ESPEC_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_CTA_ESPEC_PARTIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS RENT_CTA_ESPEC_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_CTA_ESPEC_PARTIC_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))      AS SLD_CTA_ESPEC_PARTIC_INIC
                  ,TRIM(REPLACE(DCR_CTA_ESPEC_PATROC,CHR(13),''))                                                                                   AS DCR_CTA_ESPEC_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_CTA_ESPEC_PATROC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS SLD_CTA_ESPEC_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_CTA_ESPEC_PATROC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS CTB_CTA_ESPEC_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_CTA_ESPEC_PATROC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS RENT_CTA_ESPEC_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_CTA_ESPEC_PATROC_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))      AS SLD_CTA_ESPEC_PATROC_INIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_TOT_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                   AS SLD_TOT_INIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(CTB_TOT_INIC,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                   AS CTB_TOT_INIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                   AS RENT_PERIODO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_TOT_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                    AS SLD_TOT_FIM
                  ,TRIM(REPLACE(PRM_MES_PERIODO_CTB,CHR(13),''))                                                                                    AS PRM_MES_PERIODO_CTB
                  ,TRIM(REPLACE(SEG_MES_PERIODO_CTB,CHR(13),''))                                                                                    AS SEG_MES_PERIODO_CTB
                  ,TRIM(REPLACE(TER_MES_PERIODO_CTB,CHR(13),''))                                                                                    AS TER_MES_PERIODO_CTB
                  ,TRIM(REPLACE(DCR_TOT_CTB_BD,CHR(13),''))                                                                                         AS DCR_TOT_CTB_BD                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_BD_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_BD_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_BD_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_BD_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_BD_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_BD_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_BD_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_BD_PERIODO
                  ,TRIM(REPLACE(DCR_TOT_CTB_CV,CHR(13),''))                                                                                         AS DCR_TOT_CTB_CV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_CV_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_CV_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_CV_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_CV_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_CV_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_CV_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_CV_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS VLR_TOT_CTB_CV_PERIODO
                  ,TRIM(REPLACE(DCR_TPO_CTB_VOL_PARTIC,CHR(13),''))                                                                                 AS DCR_TPO_CTB_VOL_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PARTIC_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PARTIC_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PARTIC_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PARTIC_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PARTIC_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PARTIC_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PARTIC_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PARTIC_PERIODO
                  ,TRIM(REPLACE(DCR_TPO_CTB_VOL_PATROC,CHR(13),''))                                                                                 AS DCR_TPO_CTB_VOL_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PATROC_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PATROC_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PATROC_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PATROC_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PATROC_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PATROC_TER_MES                                    
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_VOL_PATROC_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))     AS VLR_CTB_VOL_PATROC_PERIODO
                  ,TRIM(REPLACE(DCR_TPO_CTB_OBRIG_PARTIC,CHR(13),''))                                                                               AS DCR_TPO_CTB_OBRIG_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PARTIC_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PARTIC_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PARTIC_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PARTIC_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PARTIC_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PARTIC_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PARTIC_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PARTIC_PERIODO
                  ,TRIM(REPLACE(DCR_TPO_CTB_OBRIG_PATROC,CHR(13),''))                                                                               AS DCR_TPO_CTB_OBRIG_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PATROC_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PATROC_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PATROC_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PATROC_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PATROC_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PATROC_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_OBRIG_PATROC_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_OBRIG_PATROC_PERIODO
                  ,TRIM(REPLACE(DCR_TPO_CTB_ESPOR_PATROC,CHR(13),''))                                                                               AS DCR_TPO_CTB_ESPOR_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PATROC_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PATROC_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PATROC_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PATROC_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PATROC_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PATROC_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PATROC_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PATROC_PERIODO
                  ,TRIM(REPLACE(DCR_TPO_CTB_ESPOR_PARTIC,CHR(13),''))                                                                               AS DCR_TPO_CTB_ESPOR_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PARTIC_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PARTIC_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PARTIC_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PARTIC_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PARTIC_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PARTIC_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_ESPOR_PARTIC_PERIODO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_CTB_ESPOR_PARTIC_PERIODO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(TOT_CTB_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                AS TOT_CTB_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(TOT_CTB_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                AS TOT_CTB_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(TOT_CTB_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                AS TOT_CTB_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(TOT_CTB_EXTRATO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                AS TOT_CTB_EXTRATO
                  ,TRIM(REPLACE(PRM_MES_PERIODO_RENT,CHR(13),''))                                                                                   AS PRM_MES_PERIODO_RENT
                  ,TRIM(REPLACE(SEG_MES_PERIODO_RENT,CHR(13),''))                                                                                   AS SEG_MES_PERIODO_RENT
                  ,TRIM(REPLACE(TER_MES_PERIODO_RENT,CHR(13),''))                                                                                   AS TER_MES_PERIODO_RENT                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_REAL_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_REAL_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_REAL_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_REAL_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_REAL_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_REAL_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_REAL_TOT_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_REAL_TOT_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_LMTD_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_LMTD_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_LMTD_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_LMTD_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_LMTD_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_LMTD_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_LMTD_TOT_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS PCT_RENT_LMTD_TOT_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_IGPDI_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS PCT_RENT_IGPDI_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_IGPDI_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS PCT_RENT_IGPDI_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_IGPDI_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS PCT_RENT_IGPDI_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_IGPDI_TOT_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))         AS PCT_RENT_IGPDI_TOT_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_URR_PRM_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS PCT_RENT_URR_PRM_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_URR_SEG_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS PCT_RENT_URR_SEG_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_URR_TER_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS PCT_RENT_URR_TER_MES                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(PCT_RENT_URR_TOT_MES,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS PCT_RENT_URR_TOT_MES
                  ,TO_DATE(DTA_APOS_PROP,'DD/MM/RRRR')                                                                                              AS DTA_APOS_PROP
                  ,TO_DATE(DTA_APOS_INTE,'DD/MM/RRRR')                                                                                              AS DTA_APOS_INTE                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_BENEF_PSAP_PROP,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))            AS VLR_BENEF_PSAP_PROP                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_BENEF_PSAP_INTE,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))            AS VLR_BENEF_PSAP_INTE                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_BENEF_BD_PROP,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS VLR_BENEF_BD_PROP                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_BENEF_BD_INTE,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS VLR_BENEF_BD_INTE                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_BENEF_CV_PROP,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS VLR_BENEF_CV_PROP                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_BENEF_CV_INTE,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS VLR_BENEF_CV_INTE                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENDA_ESTIM_PROP,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))               AS RENDA_ESTIM_PROP                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENDA_ESTIM_INT,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                AS RENDA_ESTIM_INT                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_RESERV_SALD_LQDA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS VLR_RESERV_SALD_LQDA
                  ,TRIM(REPLACE(TXT_PRM_MENS,CHR(13),''))                                                                                           AS TXT_PRM_MENS
                  ,TRIM(REPLACE(TXT_SEG_MENS,CHR(13),''))                                                                                           AS TXT_SEG_MENS
                  ,TRIM(REPLACE(TXT_TER_MENS,CHR(13),''))                                                                                           AS TXT_TER_MENS
                  ,TRIM(REPLACE(TXT_QUA_MENS,CHR(13),''))                                                                                           AS TXT_QUA_MENS
                  ,REPLACE(IDADE_PROP_BSPS,CHR(13),'')                                                                                              AS IDADE_PROP_BSPS
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_PROP_BSPS,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS VLR_CTB_PROP_BSPS                     
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(IDADE_INT_BSPS,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                 AS IDADE_INT_BSPS                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_INT_BSPS,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))               AS VLR_CTB_INT_BSPS                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(IDADE_PROP_BD,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                  AS IDADE_PROP_BD                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_PROP_BD,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                AS VLR_CTB_PROP_BD                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(IDADE_INT_BD,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                   AS IDADE_INT_BD                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_INT_BD,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                 AS VLR_CTB_INT_BD
                  ,REPLACE(IDADE_PROP_CV,CHR(13),'')                                                                                                AS IDADE_PROP_CV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_PROP_CV,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                AS VLR_CTB_PROP_CV
                  ,REPLACE(IDADE_INT_CV,CHR(13),'')                                                                                                 AS IDADE_INT_CV                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_CTB_INT_CV,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))                 AS VLR_CTB_INT_CV
                  ,TRIM(REPLACE(DCR_COTA_INDEX_PLAN_1,CHR(13),''))                                                                                  AS DCR_COTA_INDEX_PLAN_1
                  ,TRIM(REPLACE(DCR_COTA_INDEX_PLAN_2,CHR(13),''))                                                                                  AS DCR_COTA_INDEX_PLAN_2
                  ,TRIM(REPLACE(DCR_CTA_APOS_INDIV_VOL_PARTIC,CHR(13),''))                                                                          AS DCR_CTA_APOS_INDIV_VOL_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INI_CTA_APO_INDI_VOL_PARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_INI_CTA_APO_INDI_VOL_PARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_APO_INDI_VOL_PARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS VLR_TOT_CTB_APO_INDI_VOL_PARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(REN_TOT_CTB_APO_INDI_VOL_PARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS REN_TOT_CTB_APO_INDI_VOL_PARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_APO_INDI_VOL_PARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_FIM_CTA_APO_INDI_VOL_PARTI
                  ,TRIM(REPLACE(DCR_CTA_APOS_INDIV_ESPO_PARTIC,CHR(13),''))                                                                         AS DCR_CTA_APOS_INDIV_ESPO_PARTIC                                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INI_CTA_APO_INDI_ESPOPARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_INI_CTA_APO_INDI_ESPOPARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_APO_INDI_ESPOPARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS VLR_TOT_CTB_APO_INDI_ESPOPARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(REN_TOT_CTB_APO_INDI_ESPOPARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS REN_TOT_CTB_APO_INDI_ESPOPARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_APO_INDI_ESPOPARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_FIM_CTA_APO_INDI_ESPOPARTI
                  ,TRIM(REPLACE(DCR_CTA_APOS_INDIV_VOL_PATROC,CHR(13),''))                                                                          AS DCR_CTA_APOS_INDIV_VOL_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INI_CTA_APO_INDI_VOL_PATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_INI_CTA_APO_INDI_VOL_PATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_APO_INDI_VOL_PATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS VLR_TOT_CTB_APO_INDI_VOL_PATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(REN_TOT_CTB_APO_INDI_VOL_PATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS REN_TOT_CTB_APO_INDI_VOL_PATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_APO_INDI_VOL_PATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_FIM_CTA_APO_INDI_VOL_PATRO
                  ,TRIM(REPLACE(DCR_CTA_APOS_INDIV_SUPL_PATROC,CHR(13),''))                                                                         AS DCR_CTA_APOS_INDIV_SUPL_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INI_CTA_APO_INDI_SUPLPATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_INI_CTA_APO_INDI_SUPLPATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_APO_INDI_SUPLPATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS VLR_TOT_CTB_APO_INDI_SUPLPATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(REN_TOT_CTB_APO_INDI_SUPLPATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS REN_TOT_CTB_APO_INDI_SUPLPATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_APO_INDI_SUPLPATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_FIM_CTA_APO_INDI_SUPLPATRO
                  ,TRIM(REPLACE(DCR_PORT_TOTAL,CHR(13),''))                                                                                         AS DCR_PORT_TOTAL                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INIC_CTA_PORT_TOT,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS SLD_INIC_CTA_PORT_TOT                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_PORT_TOT,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS VLR_TOT_CTB_PORT_TOT                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_TOT_CTB_PORT_TOT,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS RENT_TOT_CTB_PORT_TOT                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_PORT_TOT,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS SLD_FIM_CTA_PORT_TOT
                  ,TRIM(REPLACE(DCR_PORT_ABERTA,CHR(13)))                                                                                           AS DCR_PORT_ABERTA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INIC_CTA_PORT_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))       AS SLD_INIC_CTA_PORT_ABERTA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_PORT_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))        AS VLR_TOT_CTB_PORT_ABERTA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_TOT_CTB_PORT_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))       AS RENT_TOT_CTB_PORT_ABERTA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_PORT_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))        AS SLD_FIM_CTA_PORT_ABERTA
                  ,TRIM(REPLACE(DCR_PORT_FECHADA,CHR(13),''))                                                                                       AS DCR_PORT_FECHADA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INIC_CTA_PORT_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))      AS SLD_INIC_CTA_PORT_FECHADA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_PORT_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))       AS VLR_TOT_CTB_PORT_FECHADA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_TOT_CTB_PORT_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))      AS RENT_TOT_CTB_PORT_FECHADA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_PORT_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))       AS SLD_FIM_CTA_PORT_FECHADA
                  ,TRIM(REPLACE(DCR_PORT_JOIA_ABERTA,CHR(13),''))                                                                                   AS DCR_PORT_JOIA_ABERTA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INIC_CTA_PORT_JOIA_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))  AS SLD_INIC_CTA_PORT_JOIA_ABERTA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_PORT_JOIA_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_TOT_CTB_PORT_JOIA_ABERTA
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_TOT_CTB_PORT_JOIA_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))  AS RENT_TOT_CTB_PORT_JOIA_ABERTA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_PORT_JOIA_ABERTA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS SLD_FIM_CTA_PORT_JOIA_ABERTA
                  ,TRIM(REPLACE(DCR_PORT_JOIA_FECHADA,CHR(13),''))                                                                                  AS DCR_PORT_JOIA_FECHADA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INIC_CTA_PORT_JOIA_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS SLD_INIC_CTA_PORT_JOIA_FECHADA                 
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_PORT_JOIA_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))  AS VLR_TOT_CTB_PORT_JOIA_FECHADA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_TOT_CTB_PORT_JOIA_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.'))) AS RENT_TOT_CTB_PORT_JOIA_FECHADA                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_PORT_JOIA_FECHADA,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))  AS SLD_FIM_CTA_PORT_JOIA_FECHADA
                  ,TRIM(REPLACE(DCR_DISTR_FUND_PREV_PARTIC,CHR(13),''))                                                                             AS DCR_DISTR_FUND_PREV_PARTIC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INI_DIST_FUND_PREV_PARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS SLD_INI_DIST_FUND_PREV_PARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_DIST_FUND_PREV_PARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_TOT_DIST_FUND_PREV_PARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(REN_TOT_DIST_FUND_PREV_PARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS REN_TOT_DIST_FUND_PREV_PARTI                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLDFIM_CTA_DISTFUNDPREVPARTI,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS SLDFIM_CTA_DISTFUNDPREVPARTI
                  ,TRIM(REPLACE(DCR_DISTR_FUND_PREV_PATROC,CHR(13),''))                                                                             AS DCR_DISTR_FUND_PREV_PATROC                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INI_DIST_FUND_PREV_PATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS SLD_INI_DIST_FUND_PREV_PATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_DIST_FUND_PREV_PATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS VLR_TOT_DIST_FUND_PREV_PATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(REN_TOT_DIST_FUND_PREV_PATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS REN_TOT_DIST_FUND_PREV_PATRO                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLDFIM_CTA_DISTFUNDPREVPATRO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))   AS SLDFIM_CTA_DISTFUNDPREVPATRO
                  ,TRIM(REPLACE(DCR_PORT_FINAL,CHR(13),''))                                                                                         AS DCR_PORT_FINAL                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_INIC_CTA_PORT_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS SLD_INIC_CTA_PORT_FIM                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_TOT_CTB_PORT_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS VLR_TOT_CTB_PORT_FIM                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(RENT_TOT_CTB_PORT_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))          AS RENT_TOT_CTB_PORT_FIM                  
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(SLD_FIM_CTA_PORT_FIM,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))           AS SLD_FIM_CTA_PORT_FIM
                  ,TRIM(REPLACE(DCR_SLD_PROJETADO,CHR(13),''))                                                                                      AS DCR_SLD_PROJETADO
                  ,TO_NUMBER(TRIM(REPLACE(REPLACE(NVL(REPLACE(REPLACE(VLR_SLD_PROJETADO,' ',''), CHR(13) , ''),'0'),'.',''),',','.')))              AS VLR_SLD_PROJETADO   
...
/*            DBMS_OUTPUT.PUT_LINE(RG_TRATA_DADOS.TPO_DADO                                             ||CHR(13)||
      ...
      BEGIN
         ...
         -- TESTE
/*         DBMS_OUTPUT.PUT_LINE( G_TPO_DADO     || CHR(13) ||
                               G_COD_EMPRS    || CHR(13) ||
                               G_DTA_FIM_EXTR || CHR(13) ||
                               G_DTA_EMISS    || CHR(13) ||
                               G_DCR_PLANO    || CHR(13)
                              );*/
        ...
        BEGIN
          ...
          IF (P_COD_EMPRS IN (40, 60) ) THEN
                ...
                IF (P_CALC = 1) THEN
                  ...
                  SELECT NVL(MAX(VLR_BENEF1_HTBNF),0)
                   ...
                   WHERE NUM_MATR_PARTF   = P_NUM_MATR
                     ...
                     --AND DAT_INIVG_HTBNF = TO_DATE(P_DTA_FIM,'DD/MM/RRRR');
                     AND DAT_INIVG_HTBNF = TO_DATE(TO_CHAR(P_DTA_FIM, 'DD/MM/RRRR'), 'DD/MM/RRRR');
                ...
                ELSIF (P_CALC = 3) THEN
                  ...
                  END IF;
                  --
                  -- SUST-8330 - EFETUADO DE PARA DO SALDO ADICIONAL E BENEFICIO ADICIONAL DAS EMPRESAS 40 E 60 COM AMBIENTE DE PROD
                  ELSIF (P_CALC = 4) THEN
                  --
                  SELECT NVL(ROUND(SUM(SCPF.VLR_SDANT_SDCTPR + SCPF.VLR_ENTMES_SDCTPR - SCPF.VLR_SAIMES_SDCTPR), 2), 0.00) AS VLR_RES1
                    INTO R_RES1
                   ...
                   WHERE SCPF.NUM_MATR_PARTF = PF.NUM_MATR_PARTF
                     ...
                     AND PF.NUM_MATR_PARTF = P_NUM_MATR;  --43513;                     
                  --
                  --
                  SELECT ROUND(MAX(VLR_CDIAUM), 2) AS VLR_CDIAUM
                    INTO R_RES2
                    FROM COTACAO_DIA_UM
                    WHERE COD_UM = 248
   ...
   PROCEDURE PROC_EXT_PREV_TIETE(P_COD_EMPRESA   ATT.FC_PRE_TBL_BASE_EXTRAT_CTB.COD_EMPRS%TYPE,
    ...
    BEGIN
         ...
         CURSOR C_BASE( P_CR_CODEMPRS  ATT.FC_PRE_TBL_BASE_EXTRAT_CTB.COD_EMPRS%TYPE
              ...
              SELECT X.COD_EMPRS       AS COD_EMPRS
               ...
               WHERE X.COD_EMPRS        = P_COD_EMPRESA
                 ...
                 --AND Y.NUM_MATR_PARTF IN (79606,52815)
      ...
      BEGIN
            ...
            --
/*            DBMS_OUTPUT.PUT_LINE( 'VLR_BENEF_BD_PROP --> ' || TB_REC_BASE.VLR_BENEF_BD_PROP || CHR(13) ||
                                  'VLR_BENEF_BD_INTE --> ' || TB_REC_BASE.VLR_BENEF_BD_INTE || CHR(13) ||
                                  'RENDA_ESTIM_PROP  --> ' || TB_REC_BASE.RENDA_ESTIM_PROP  || CHR(13) ||
                                  'RENDA_ESTIM_INT   --> ' || TB_REC_BASE.RENDA_ESTIM_INT   || CHR(13) ||
                                  'VLR_CTB_PROP_BD   --> ' || TB_REC_BASE.VLR_CTB_PROP_BD   || CHR(13) ||
                                  'VLR_CTB_INT_BD    --> ' || TB_REC_BASE.VLR_CTB_INT_BD    || CHR(13)
                                 );*/
  ...
  BEGIN
      ...
      CURSOR C_BASE( P_CR_CODEMPRS  ATT.FC_PRE_TBL_BASE_EXTRAT_CTB.COD_EMPRS%TYPE
        ...
        SELECT X.COD_EMPRS       AS COD_EMPRS
         ...
         WHERE X.COD_EMPRS        = P_CR_CODEMPRS
           ...
           --AND Y.NUM_MATR_PARTF   = 76524 --43513, 41433 -- TESTE
    ...
    BEGIN
      ...
      LOOP
        ...
        --
/*        DBMS_OUTPUT.PUT_LINE( 'VLR_BENEF_BD_INTE'   || ' --> ' || TB_REC_BASE.VLR_BENEF_BD_INTE              || CHR(13) ||
                              'RENDA_ESTIM_PROP'    || ' --> ' || TB_REC_BASE.RENDA_ESTIM_PROP               || CHR(13) ||
                              'RENDA_ESTIM_INT'     || ' --> ' || TB_REC_BASE.RENDA_ESTIM_INT                || CHR(13) ||
                              'VLR_CTB_INT_BD'      || ' --> ' || TB_REC_BASE.VLR_CTB_INT_BD                 || CHR(13) ||
                              'VLR_CTB_PROP_BD'     || ' --> ' || TB_REC_BASE.VLR_CTB_PROP_BD                || CHR(13) ||
                              'VLR_SLD_ADICIONAL'   || ' --> ' || NVL(TB_REC_BASE.VLR_SLD_ADICIONAL, 0.00)   || CHR(13) ||
                              'VLR_BENEF_ADICIONAL' || ' --> ' || NVL(TB_REC_BASE.VLR_BENEF_ADICIONAL, 0.00) || CHR(13)          
                             );*/
        
        
        UPDATE ATT.FC_PRE_TBL_BASE_EXTRAT_CTB A
           SET  VLR_BENEF_BD_PROP   = 0.00
               ...
               ,VLR_CTB_PROP_BD     = 0.00
               ,VLR_SLD_ADICIONAL   = ROUND(NVL(TB_REC_BASE.VLR_SLD_ADICIONAL, 0.00), 2)
               ,VLR_BENEF_ADICIONAL = ROUND(NVL(TB_REC_BASE.VLR_SLD_ADICIONAL / 130, 0.00), 2)
          WHERE TPO_DADO        = RG.TPO_DADO
            AND COD_EMPRS       = RG.COD_EMPRS
            AND NUM_RGTRO_EMPRG = RG.NUM_RGTRO_EMPRG
            AND DTA_FIM_EXTR    = L_DTA_FIM;
